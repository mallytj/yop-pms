...
// clearStatement pairs a DELETE with the fixture label used in error messages.
...
func clearPropertyData(ctx context.Context, conn *pgx.Conn, propertyID string) error {
	return executeStatements(ctx, conn, propertyID, []clearStatement{
...
func executeStatements(ctx context.Context, conn *pgx.Conn, propertyID string, statements []clearStatement) error {
