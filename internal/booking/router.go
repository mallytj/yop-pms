...
func Routes(svc *Service, ifMatch func(http.Handler) http.Handler) func(chi.Router) {
	...
	return func(r chi.Router) {
		...
		r.Route("/{id}", func(r chi.Router) {
			...
			r.With(ifMatch, yopMw.RequirePermission("reservations:checkin")).Patch("/checkin", h.CheckinReservation)
			r.With(ifMatch, yopMw.RequirePermission("reservations:checkout")).Patch("/checkout", h.CheckoutReservation)
