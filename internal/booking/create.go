...
// create.go — Reservation creation flow:
//   - HTTP handlers: Create, Get, List
//   - Service: CreateReservation, ConfirmReservation
//   - Helpers: createReservationInTx, resolvePrimaryGuest, computeEnvelope, computeExpiresAt,
//     insertAllItems, insertSingleItem, insertItemLedgerAndRates, reactivateItemInventory,
