...
func TestHandler_GetBookedRates_NotImplemented(t *testing.T) {
...
func TestHandler_AdjustRate_NotImplemented(t *testing.T) {
	body := bytes.NewReader([]byte(`{}`))
...
func TestHandler_ApproveAdjustments_NotImplemented(t *testing.T) {
